...
export type ProductCategorySnippetFragment = (
  { __typename?: 'ProductCategory' }
  & Pick<ProductCategory, 'id' | 'name' | 'slug'>
  & { image?: Maybe<(
    { __typename?: 'MediaItem' }
    & Pick<MediaItem, 'id' | 'altText' | 'sourceUrl'>
  )> }
);
...
export type ProductSnippetFragment = ProductSnippet_ExternalProduct_Fragment | ProductSnippet_GroupProduct_Fragment | ProductSnippet_SimpleProduct_Fragment | ProductSnippet_VariableProduct_Fragment;
...
export const ProductCategorySnippetFragmentDoc = gql`
    fragment ProductCategorySnippet on ProductCategory {
  id
  name
  slug
  image {
...
export const GetCategoriesDocument = gql`
  ...
  productCategories(first: $first, after: $after, where: $where) {
    ...
    ${ProductCategorySnippetFragmentDoc}`;
