...
const USPItem: React.FC<Props> = ({ usp }) => {
  return (
    <li
      key={usp.title}
      className="bg-primary-lightest rounded shadow border border-primary-light grid grid-cols-[auto,1fr] grid-rows-[auto,auto] gap-x-2 px-2 py-4 lg:flex lg:flex-col lg:items-center lg:text-center lg:p-4 lg:pt-10 lg:gap-0"
    >
